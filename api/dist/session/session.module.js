...
exports.SessionModule = SessionModule = __decorate([
    (0, common_1.Module)({
        providers: [session_service_1.SessionService, session_auth_guard_1.SessionAuthGuard],
        exports: [session_service_1.SessionService, session_auth_guard_1.SessionAuthGuard],
    })
], SessionModule);
