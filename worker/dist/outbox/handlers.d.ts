 ...
 */
export declare const outboxEventHandlers: Record<string, OutboxEventHandler>;
export declare function registerOutboxHandler(eventType: string, handler: OutboxEventHandler): void;
