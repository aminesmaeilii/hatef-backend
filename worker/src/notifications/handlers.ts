...
function isNotificationDeliverPayload(value: unknown): value is NotificationDeliverPayload {
  return typeof value === "object" && value !== null && typeof (value as { notificationDeliveryId?: unknown }).notificationDeliveryId === "string";
}
 ...
 */
export function createNotificationDeliverHandler(env: Env): OutboxEventHandler {
